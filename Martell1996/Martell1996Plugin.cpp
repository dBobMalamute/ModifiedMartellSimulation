...
{
    ideaRegistry->registerIdea<Martell1996Idea>();
    ideaRegistry->registerIdea<Martell1996DataDisplayIdea>();
...
{
    dataTypeRegistry->registerDataTypeAttributes<Martell1996DataTypeAttributes>();
...
void Martell1996Plugin::registerToolbars(std::shared_ptr<ToolbarRegistry> toolbarRegistry)
{
    ...
    orderList << Magic<Martell1996Attributes>::cast().listName();
    orderList << Magic<ModifiedMartellAttributes>::cast().listName();
    orderList << Magic<Martell1996DataDisplayAttributes>::cast().listName();
